...
<div class="flex-1 p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="flex-shrink-0">
                    <svg class="h-12 w-12 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 8c.6 0 1 .4 1 1v3h3c.6 0 1 .4 1 1s-.4 1-1-1h-3v3c0 .6-.4 1-1 1s-1-.4-1-1v-3H8c-.6 0-1-.4-1-1s.4-1 1-1h3V9c0-.6.4-1 1-1z" />
                    </svg>
                </div>
                <div class="ml-4">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <svg class="h-12 w-12 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 10l1.45-2.9A2 2 0 015.25 6h13.5a2 2 0 011.8 1.1L21 10M3 10l9 6m0 0l9-6m-9 6v5m0-5L3 10m18 0l-9 6" />
                    </svg>
                </div>
                <div class="ml-4">
            ...
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <svg class="h-12 w-12 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 8c-3.866 0-7 1.79-7 4s3.134 4 7 4 7-1.79 7-4-3.134-4-7-4zm0 0V6m0 10v2m-3-2a3 3 0 106 0" />
                    </svg>
                </div>
                <div class="ml-4">
