...
<body class="bg-gray-100">
    ...
    <div class="flex">
        <!-- Sidebar -->
        <aside id="sidebar"
            class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2 min-h-screen absolute inset-y-0 left-0 transform -translate-x-full lg:relative lg:translate-x-0 transition duration-200 ease-in-out">
            <!-- Close Button -->
            ...
            <div class="flex items-center space-x-2 px-4">
                ...
                <span class="text-xl font-bold capitalize"><?php echo ucfirst($_SESSION['role']); ?></span>
            </div>
